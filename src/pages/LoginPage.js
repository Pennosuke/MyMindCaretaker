...
class LoginPage extends Component {
  ...
  componentDidMount(){
    document.title = "MMC : เข้าสู่ระบบ"
  }
  ...
  render() {
    return (
      <Row style={{ backgroundColor: '#7BDAF8', height: '100vh', alignItems: 'center', justifyContent: 'center' }}>
        <Col span={10} style={{ backgroundColor: 'white', padding: 10, borderRadius: 10 }}>
          <Row style={{ marginTop: 20, marginBottom: 20 }} align='center'>
            <Col span={18}>
              <Row>
                <Col span={24} align='center' style={{ marginTop: 20, marginBottom: 40 }}>
                  <img src={logo} width='150' />
                </Col>
                <Col span={24} align='center'>
                  อีเมล
                </Col>
                <Col span={24} align='center' style={{ marginBottom: 20 }}>
                  <Input
                    placeholder="อีเมล"
                ...
                <Col span={24} align='center' style={{ marginTop: 40 }}>
